...
screen main_menu():
    ...
    imagemap:
        idle "gui/Кнопки.png"
        hover"gui/Кнопки2.0.png"

        hotspot(4, 6, 455, 106) action Start()
        hotspot(4, 133, 455, 106) action ShowMenu("load")
        hotspot(4, 260, 455, 106) action ShowMenu("preferences")
        hotspot(4, 600, 455, 106) action Quit(confirm=True)
